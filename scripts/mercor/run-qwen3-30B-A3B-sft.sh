...
SCRIPT_DIR="${SLIME_DIR:-/workspace/slime/scripts}"
...
CKPT_ARGS=(
   ...
   --load ${BASE_FOLDER}/Qwen3-30B-A3B-Thinking-2507_slime/
   --save ${BASE_FOLDER}/Qwen3-30B-A3B-Thinking-2507_slime/
   --save-interval 1000
)

SFT_ARGS=(
   --rollout-function-path slime.rollout.sft_rollout.generate_rollout
   --prompt-data /workspace/data/apex_sft_least_turns.jsonl
   --input-key messages
   # --apply-chat-template
   --rollout-shuffle
   --num-epoch 3
