#!/bin/bash
#
# Full pipeline: train lr=2e5 -> convert last ckpt to HF -> upload to HF
# Runs on worker node (92.38.143.26) inside slime docker container
#
set -ex
...
REPO_NAME="eigen-ai-labs/Qwen3-30B-A3B-sft-v2-0314-lr2e5"
