...
MODEL_CONFIGS = {
    ...
    "qwen3_30b_mc": {
        ...
        "model": "Qwen3-30B-A3B-Thinking-2507-sft-opus-management-consulting",
        "api_key": "dummy",
        "extra_params": {},
        "context_window": 131072,
    },
    "qwen3_30b_ib": {
        ...
        "model": "Qwen3-30B-A3B-Thinking-2507-sft-opus-investment-banking",
        "api_key": "dummy",
        "extra_params": {},
        "context_window": 131072,
    },
    "qwen3_30b_law": {
        ...
        "model": "Qwen3-30B-A3B-Thinking-2507-sft-opus-law",
        "api_key": "dummy",
        "extra_params": {},
        "context_window": 131072,
    },
    ...
    if not has_valid_tool_calls:
        ...
        if "</tool_call>" in text_to_parse:
            ...
            _tc_pattern = _re.compile(
                r'(?:<tool_call>\s*)?(\{[^{}]*"name"\s*:\s*"[^"]+"\s*,\s*"arguments"\s*:\s*\{.*?\}\s*\})\s*</tool_call>',
                _re.DOTALL,
            )
            fallback_tcs = []
...
def run_single_task(task, tools_openai, tool_functions, fs_root, tool_server_paths=None):
    ...
    system_content = SYSTEM_PROMPT.format(filesystem_root=fs_root)
