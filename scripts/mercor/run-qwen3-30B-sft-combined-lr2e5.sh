...
# lr=2e-5, 5 epochs, batch_size=16
# Run on worker node inside slime docker container
#
...
SAVE_NAME="Qwen3-30B-A3B-sft-v2-0314-lr2e5"
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-30B-A3B-sft-v2-0314-lr2e5
